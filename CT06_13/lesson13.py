...
# question = input("what do you call a bear without both ears?")

# hidden = "b"
# hidden2 = "B"

# if question == hidden or question == hidden2:
#     print("correct!")
# else:
#     print("wrong")
...
# closet[3] = "bling bling diamond ring"
# del(closet[2])
# closet.append("ear rings")
